...
namespace ControlUnit
{
    public class HeatControl
    {
        ...
        public HeatControl()
        {
            ...
            var veryCool = error.MembershipFunctions.AddTriangle("Very Cool", -18, -7, -4);
            ...
            var veryHot = error.MembershipFunctions.AddTriangle("Very Hot", 4, 11, 18);

            //bemeneti derivalt univerzum
            var dt = new LinguisticVariable("Derivate");
            var veryCooling = dt.MembershipFunctions.AddTriangle("Very Cooling", -1, -0.65, 0.3);
            ...
            var veryHeating = dt.MembershipFunctions.AddTriangle("Very Heating", 0.3, 0.65, 1);
        ...
        public double Control(double errorInput, double derivateInput)
        {
            ...
            var result = _fuzzyEngine.Defuzzify(new { Error = errorInput , Derivate = derivateInput });
            return result;
